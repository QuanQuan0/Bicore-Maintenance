...
public:
    ...
    std::map<std::vector<int>, std::map<int,int>> is_in_wait_tobe_visit_u; std::map<std::vector<int>, std::map<int,int>> is_in_wait_tobe_visit_v;
...
public:
	...
	// for dynamic update
	std::vector<std::vector<int>> left_index_change;
	std::vector<std::vector<int>> right_index_change;

	std::vector<std::vector<int>> left_index_delete;
	std::vector<std::vector<int>> right_index_delete;
...
extern void build_skyline_index(BiGraph&g, std::vector<std::vector<bicore_index_block*>>& bicore_index_u, std::vector<std::vector<bicore_index_block*>>& bicore_index_v,
                                std::vector<skyline_block*>& skyline_index_u, std::vector<skyline_block*>& skyline_index_v, std::vector<skyline_block*>& skyline_index_u_reverse, std::vector<skyline_block*>& skyline_index_v_reverse);

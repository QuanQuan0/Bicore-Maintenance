...
extern void generate_Erdos_Renyi_random_graph(int left_size, int right_size, int avg_deg, std::string output_location);

extern void generate_Barabasi_Albert_random_graph(int left_size, int right_size, double avg_deg, std::string output_location);

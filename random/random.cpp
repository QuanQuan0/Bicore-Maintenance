...
void generate_Erdos_Renyi_random_graph(int left_size, int right_size, int avg_deg, string output_location) {
...
void generate_Barabasi_Albert_random_graph(int left_size, int right_size, double avg_deg, string output_location) {
	int bonus = 2;
	BiGraph g;
	g.init(left_size, right_size);
	int num_edge = (left_size + right_size) * avg_deg / 2;
